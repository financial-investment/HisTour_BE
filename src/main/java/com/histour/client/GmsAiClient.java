    ...
    private String buildRequestBody(String model, String imageDataUrl,
        ...
        try {
            ...
            sb.append("""
                    ...
                    찾은 문화재에 대해 아래 5단계 구조로 해설을 작성하세요:

                    [1단계: 도입]
                    이 장소에서 일어난 가장 극적이거나 인상적인 역사적 순간을 현재 시제로 묘사하며 시작하세요.
                    방문객이 그 순간 속으로 빨려 들어가는 느낌이어야 합니다. 매번 다른 방식으로 시작하세요.

                    [2단계: 인물·사건]
                    이 문화재와 가장 깊이 연관된 실존 인물 한 명 또는 구체적인 역사적 사건을 중심으로 이야기를 전개하세요.
                    그 인물의 감정, 결단, 또는 그 사건의 긴장감을 살려주세요.

                    [3단계: 시대 맥락]
                    당시 사람들이 이 장소를 어떻게 느꼈을지, 시대적 분위기 속에서 이 문화재가 가진 의미를 설명하세요.

                    [4단계: 현장 디테일]
                    지금 방문객이 눈앞에서 볼 수 있는 건축적·예술적 특징 하나를 콕 짚어 그 의미를 설명하세요.

                    [5단계: 여운]
                    과거와 현재를 잇는 문장으로 마무리하세요. 방문객이 집에 돌아가서도 기억할 만한 한 마디.
